/**
 * Generates posts-index.json from _posts directory (optional - for performance)
 * Also generates _posts/manifest.json (simple filename list - required fallback)
 *
 * Note: The blog engine works without this - it can read from manifest.json
 * This script is optional but recommended for faster loading.
 */
