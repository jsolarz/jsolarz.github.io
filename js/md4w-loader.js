...
class MD4WLoader {
	...
	async _loadMD4W() {
		try {
			...
			return {
				mdToHtml: (markdown) => {
					return markdown.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/\n/g, "<br>")
				},
			}
		}
	}
...
if (typeof window !== "undefined" && (window.location.pathname.includes("/blog") || document.querySelector(".post-list"))) {
